Promise.all([
    ...
    , customElements.whenDefined('sl-input')
          ...
          document.querySelector('#Page_averageCrowdSpeed')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_averageCrowdSpeed')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_averageCrowdSpeed')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_averageCrowdSpeed');
            const valid = form.reportValidity();
          });

          // PATCH averageHeadwayTime
          document.querySelector('#Page_averageHeadwayTime')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_averageHeadwayTime')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_averageHeadwayTime')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_averageHeadwayTime');
            const valid = form.reportValidity();
          });

          // PATCH congested
          document.querySelector('#Page_congested')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_congested')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_congested')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_congested');
            const valid = form.reportValidity();
          });
          ...
          document.querySelector('#Page_dateObservedFrom')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_dateObservedFrom')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_dateObservedFrom')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_dateObservedFrom');
            const valid = form.reportValidity();
          });

          // PATCH dateObservedTo
          document.querySelector('#Page_dateObservedTo')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_dateObservedTo')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_dateObservedTo')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_dateObservedTo');
            const valid = form.reportValidity();
          });

          // PATCH direction
          document.querySelector('#Page_direction')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_direction')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_direction')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_direction');
            const valid = form.reportValidity();
          });

          // PATCH occupancy
          document.querySelector('#Page_occupancy')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_occupancy')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_occupancy')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_occupancy');
            const valid = form.reportValidity();
          });
          ...
          // PATCH peopleCount
          document.querySelector('#Page_peopleCount')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_peopleCount')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_peopleCount')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_peopleCount');
            const valid = form.reportValidity();
          });

          // PATCH refRoadSegment
          document.querySelector('#Page_refRoadSegment')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_refRoadSegment')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_refRoadSegment')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_refRoadSegment');
            const valid = form.reportValidity();
          });
