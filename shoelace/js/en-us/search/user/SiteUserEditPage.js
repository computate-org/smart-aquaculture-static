Promise.all([
    ...
    , customElements.whenDefined('sl-input')
          ...
          // PATCH awesomeEffect
          document.querySelector('#Page_awesomeEffect')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_awesomeEffect')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_awesomeEffect')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_awesomeEffect');
            const valid = form.reportValidity();
          });

          // PATCH siteTheme
          document.querySelector('#Page_siteTheme')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_siteTheme')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_siteTheme')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_siteTheme');
            const valid = form.reportValidity();
          });

          // PATCH webComponentsTheme
          document.querySelector('#Page_webComponentsTheme')?.addEventListener('sl-change', (event) => {
          ...
          document.querySelector('#Page_webComponentsTheme')?.addEventListener('sl-focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_webComponentsTheme')?.addEventListener('sl-blur', (event) => {
            const form = document.querySelector('#PageForm_webComponentsTheme');
            const valid = form.reportValidity();
          });
