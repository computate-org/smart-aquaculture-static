...
async function searchCrowdFlowObserved($formFilters, success, error) {
  ...
  searchCrowdFlowObservedVals(filters, target, success, error);
}
...
function searchCrowdFlowObservedFilters($formFilters) {
  ...
  if($formFilters) {
    ...
    var filterAverageCrowdSpeed = $formFilters.querySelector('.valueAverageCrowdSpeed')?.value;
    ...
    var filterAverageHeadwayTime = $formFilters.querySelector('.valueAverageHeadwayTime')?.value;
    ...
    var $filterCongestedCheckbox = $formFilters.querySelector('input.valueCongested[type = "checkbox"]');
    var $filterCongestedSelect = $formFilters.querySelector('select.valueCongested');
    var filterCongested = $filterCongestedSelect.length ? $filterCongestedSelect.value : $filterCongestedCheckbox.checked;
    var filterCongestedSelectVal = $formFilters.querySelector('select.filterCongested')?.value;
    ...
    var filterPeopleCount = $formFilters.querySelector('.valuePeopleCount')?.value;
    if(filterPeopleCount != null && filterPeopleCount !== '')
      filters.push({ name: 'fq', value: 'peopleCount:' + filterPeopleCount });

    var filterRefRoadSegment = $formFilters.querySelector('.valueRefRoadSegment')?.value;
...
function searchCrowdFlowObservedVals(filters, target, success, error) {


  fetch(
    '/en-us/api/crowd-flow-observed?' + filters.map(function(m) { return m.name + '=' + encodeURIComponent(m.value) }).join('&')
    , {
...
function suggestCrowdFlowObservedObjectSuggest($formFilters, $list, target) {
  ...
  error = function( jqXhr, textStatus, errorThrown ) {};
  searchCrowdFlowObservedVals($formFilters, target, success, error);
}
...
async function getCrowdFlowObserved(pk) {
  fetch(
    '/en-us/api/crowd-flow-observed/' + entityShortId
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
    }).then(response => {
      if(response.ok) {
...
async function patchCrowdFlowObserved($formFilters, $formValues, target, entityShortId, success, error) {
  ...
  var valueAverageCrowdSpeed = $formValues.querySelector('.valueAverageCrowdSpeed')?.value;
  var removeAverageCrowdSpeed = $formValues.querySelector('.removeAverageCrowdSpeed')?.value === 'true';
  var setAverageCrowdSpeed = removeAverageCrowdSpeed ? null : $formValues.querySelector('.setAverageCrowdSpeed')?.value;
  var addAverageCrowdSpeed = $formValues.querySelector('.addAverageCrowdSpeed')?.value;
  ...
  var removeAverageCrowdSpeed = $formValues.querySelector('.removeAverageCrowdSpeed')?.value;
  if(removeAverageCrowdSpeed != null && removeAverageCrowdSpeed !== '')
    vals['removeAverageCrowdSpeed'] = removeAverageCrowdSpeed;

  var valueAverageHeadwayTime = $formValues.querySelector('.valueAverageHeadwayTime')?.value;
  var removeAverageHeadwayTime = $formValues.querySelector('.removeAverageHeadwayTime')?.value === 'true';
  var setAverageHeadwayTime = removeAverageHeadwayTime ? null : $formValues.querySelector('.setAverageHeadwayTime')?.value;
  var addAverageHeadwayTime = $formValues.querySelector('.addAverageHeadwayTime')?.value;
  ...
  var removeAverageHeadwayTime = $formValues.querySelector('.removeAverageHeadwayTime')?.value;
  if(removeAverageHeadwayTime != null && removeAverageHeadwayTime !== '')
    vals['removeAverageHeadwayTime'] = removeAverageHeadwayTime;

  var valueCongested = $formValues.querySelector('.valueCongested')?.value;
  var removeCongested = $formValues.querySelector('.removeCongested')?.value === 'true';
  if(valueCongested != null)
    valueCongested = valueCongested === 'true';
  var valueCongestedSelectVal = $formValues.querySelector('select.setCongested')?.value;
  if(valueCongestedSelectVal != null)
    valueCongestedSelectVal = valueCongestedSelectVal === 'true';
  ...
  var addCongested = $formValues.querySelector('.addCongested')?.checked;
  ...
  var removeCongested = $formValues.querySelector('.removeCongested')?.checked;
  ...
  var valueDateObservedFrom = $formValues.querySelector('.valueDateObservedFrom')?.value;
  var removeDateObservedFrom = $formValues.querySelector('.removeDateObservedFrom')?.value === 'true';
  var setDateObservedFrom = removeDateObservedFrom ? null : $formValues.querySelector('.setDateObservedFrom')?.value;
  var addDateObservedFrom = $formValues.querySelector('.addDateObservedFrom')?.value;
  ...
  var removeDateObservedFrom = $formValues.querySelector('.removeDateObservedFrom')?.value;
  if(removeDateObservedFrom != null && removeDateObservedFrom !== '')
    vals['removeDateObservedFrom'] = removeDateObservedFrom;

  var valueDateObservedTo = $formValues.querySelector('.valueDateObservedTo')?.value;
  var removeDateObservedTo = $formValues.querySelector('.removeDateObservedTo')?.value === 'true';
  var setDateObservedTo = removeDateObservedTo ? null : $formValues.querySelector('.setDateObservedTo')?.value;
  var addDateObservedTo = $formValues.querySelector('.addDateObservedTo')?.value;
  ...
  var removeDateObservedTo = $formValues.querySelector('.removeDateObservedTo')?.value;
  if(removeDateObservedTo != null && removeDateObservedTo !== '')
    vals['removeDateObservedTo'] = removeDateObservedTo;

  var valueDirection = $formValues.querySelector('.valueDirection')?.value;
  var removeDirection = $formValues.querySelector('.removeDirection')?.value === 'true';
  var setDirection = removeDirection ? null : $formValues.querySelector('.setDirection')?.value;
  var addDirection = $formValues.querySelector('.addDirection')?.value;
  ...
  var removeDirection = $formValues.querySelector('.removeDirection')?.value;
  if(removeDirection != null && removeDirection !== '')
    vals['removeDirection'] = removeDirection;

  var valueOccupancy = $formValues.querySelector('.valueOccupancy')?.value;
  var removeOccupancy = $formValues.querySelector('.removeOccupancy')?.value === 'true';
  var setOccupancy = removeOccupancy ? null : $formValues.querySelector('.setOccupancy')?.value;
  var addOccupancy = $formValues.querySelector('.addOccupancy')?.value;
  ...
  var removeOccupancy = $formValues.querySelector('.removeOccupancy')?.value;
  ...
  var valuePeopleCount = $formValues.querySelector('.valuePeopleCount')?.value;
  var removePeopleCount = $formValues.querySelector('.removePeopleCount')?.value === 'true';
  var setPeopleCount = removePeopleCount ? null : $formValues.querySelector('.setPeopleCount')?.value;
  var addPeopleCount = $formValues.querySelector('.addPeopleCount')?.value;
  ...
  var removePeopleCount = $formValues.querySelector('.removePeopleCount')?.value;
  if(removePeopleCount != null && removePeopleCount !== '')
    vals['removePeopleCount'] = removePeopleCount;

  var valueRefRoadSegment = $formValues.querySelector('.valueRefRoadSegment')?.value;
  var removeRefRoadSegment = $formValues.querySelector('.removeRefRoadSegment')?.value === 'true';
  var setRefRoadSegment = removeRefRoadSegment ? null : $formValues.querySelector('.setRefRoadSegment')?.value;
  var addRefRoadSegment = $formValues.querySelector('.addRefRoadSegment')?.value;
  ...
  var removeRefRoadSegment = $formValues.querySelector('.removeRefRoadSegment')?.value;
  ...
  patchCrowdFlowObservedVals(entityShortId == null ? deparam(window.location.search ? window.location.search.substring(1) : window.location.search) : [{name:'fq', value:'entityShortId:' + entityShortId}], vals, target, success, error);
}
...
function patchCrowdFlowObservedVal(filters, v, val, target, success, error) {
  var vals = {};
  vals[v] = val;
  patchCrowdFlowObservedVals(filters, vals, target, success, error);
}

function patchCrowdFlowObservedVals(filters, vals, target, success, error) {
  fetch(
    '/en-us/api/crowd-flow-observed?' + filters.map(function(m) { return m.name + '=' + encodeURIComponent(m.value) }).join('&')
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
...
async function postCrowdFlowObserved($formValues, target, success, error) {
  var vals = {};
  if(success == null) {
    success = function( data, textStatus, jQxhr ) {
      addGlow(target);
...
function postCrowdFlowObservedVals(vals, target, success, error) {
  fetch(
    '/en-us/api/crowd-flow-observed'
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
...
async function deleteCrowdFlowObserved(target, entityShortId, success, error) {
  if(success == null) {
    success = function( data, textStatus, jQxhr ) {
      addGlow(target);
      var url = data['editPage'];
  ...
  fetch(
    '/en-us/api/crowd-flow-observed/' + encodeURIComponent(entityShortId)
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
      , method: 'DELETE'
    }).then(response => {
...
async function putimportCrowdFlowObserved($formValues, target, entityShortId, success, error) {
  var json = $formValues.querySelector('.PUTImport_searchList')?.value;
  if(json != null && json !== '')
    putimportCrowdFlowObservedVals(JSON.parse(json), target, success, error);
}

function putimportCrowdFlowObservedVals(json, target, success, error) {
  fetch(
    '/en-us/api/crowd-flow-observed-import'
    , {
      headers: {'Content-Type':'application/json; charset=utf-8'}
      , method: 'PUT'
...
async function deletefilterCrowdFlowObserved(target, success, error) {
  if(success == null) {
    success = function( data, textStatus, jQxhr ) {
      addGlow(target);
      var url = data['editPage'];
...
async function websocketCrowdFlowObserved(success) {
  window.eventBus.onopen = function () {
    ...
    window.eventBus.registerHandler('websocketCrowdFlowObserved', function (error, message) {
      ...
      iTemplate.innerHTML = '<i class="fa-duotone fa-regular fa-users-viewfinder"></i>';
      var $i = iTemplate.content;
      var $headerSpan = document.createElement('span');
      $headerSpan.setAttribute('class', '');
      $headerSpan.innerText = 'modify CrowdFlowObserveds in ' + json.timeRemaining;
    ...
    fetch(uri).then(response => {
      response.text().then(text => {
        ...
        if(vars.includes('averageCrowdSpeed'))
          inputAverageCrowdSpeed = $response.querySelector('.Page_averageCrowdSpeed');
        if(vars.includes('averageHeadwayTime'))
          inputAverageHeadwayTime = $response.querySelector('.Page_averageHeadwayTime');
        if(vars.includes('congested'))
          inputCongested = $response.querySelector('.Page_congested');
        ...
        if(vars.includes('dateObservedFrom'))
          inputDateObservedFrom = $response.querySelector('.Page_dateObservedFrom');
        if(vars.includes('dateObservedTo'))
          inputDateObservedTo = $response.querySelector('.Page_dateObservedTo');
        if(vars.includes('direction'))
          inputDirection = $response.querySelector('.Page_direction');
        if(vars.includes('occupancy'))
          inputOccupancy = $response.querySelector('.Page_occupancy');
        if(vars.includes('owner'))
          inputOwner = $response.querySelector('.Page_owner');
        if(vars.includes('peopleCount'))
          inputPeopleCount = $response.querySelector('.Page_peopleCount');
        if(vars.includes('refRoadSegment'))
          inputRefRoadSegment = $response.querySelector('.Page_refRoadSegment');
        ...
        window.listCrowdFlowObserved = JSON.parse($response.querySelector('.pageForm .listCrowdFlowObserved')?.value);
        ...
        if(inputAverageCrowdSpeed) {
          document.querySelectorAll('.Page_averageCrowdSpeed').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputAverageCrowdSpeed.getAttribute('value');
            else
              item.textContent = inputAverageCrowdSpeed.textContent;
          });
          addGlow(document.querySelector('.Page_averageCrowdSpeed'));
        }

        if(inputAverageHeadwayTime) {
          document.querySelectorAll('.Page_averageHeadwayTime').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputAverageHeadwayTime.getAttribute('value');
            else
              item.textContent = inputAverageHeadwayTime.textContent;
          });
          addGlow(document.querySelector('.Page_averageHeadwayTime'));
        }

        if(inputCongested) {
          document.querySelectorAll('.Page_congested').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputCongested.getAttribute('value');
            else
              item.textContent = inputCongested.textContent;
          });
          addGlow(document.querySelector('.Page_congested'));
        }
        ...
        if(inputDateObservedFrom) {
          document.querySelectorAll('.Page_dateObservedFrom').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDateObservedFrom.getAttribute('value');
            else
              item.textContent = inputDateObservedFrom.textContent;
          });
          addGlow(document.querySelector('.Page_dateObservedFrom'));
        }

        if(inputDateObservedTo) {
          document.querySelectorAll('.Page_dateObservedTo').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDateObservedTo.getAttribute('value');
            else
              item.textContent = inputDateObservedTo.textContent;
          });
          addGlow(document.querySelector('.Page_dateObservedTo'));
        }

        if(inputDirection) {
          document.querySelectorAll('.Page_direction').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputDirection.getAttribute('value');
            else
              item.textContent = inputDirection.textContent;
          });
          addGlow(document.querySelector('.Page_direction'));
        }

        if(inputOccupancy) {
          document.querySelectorAll('.Page_occupancy').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputOccupancy.getAttribute('value');
            else
              item.textContent = inputOccupancy.textContent;
          });
          addGlow(document.querySelector('.Page_occupancy'));
        }
        ...
        if(inputPeopleCount) {
          document.querySelectorAll('.Page_peopleCount').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputPeopleCount.getAttribute('value');
            else
              item.textContent = inputPeopleCount.textContent;
          });
          addGlow(document.querySelector('.Page_peopleCount'));
        }

        if(inputRefRoadSegment) {
          document.querySelectorAll('.Page_refRoadSegment').forEach((item, index) => {
            if(typeof item.value !== 'undefined')
              item.value = inputRefRoadSegment.getAttribute('value');
            else
              item.textContent = inputRefRoadSegment.textContent;
          });
          addGlow(document.querySelector('.Page_refRoadSegment'));
        }
...
function pageGraphCrowdFlowObserved(apiRequest) {
  ...
  if(r) {
    ...
    if(json['facetCounts']) {
      ...
      if(facetCounts['facetPivot'] && facetCounts['facetRanges']) {
        ...
        if(range) {
          ...
          Plotly.react('htmBodyGraphCrowdFlowObservedPage', data, layout);
        }
      }
    }
    ...
    window.mapLayers = {};
    window.bounds = null;
    if(listCrowdFlowObserved.filter(o => o.location)) {
      window.bounds = L.latLngBounds(listCrowdFlowObserved.filter(o => o.location).map((c) => {
    ...
    if(window.mapCrowdFlowObserved) {
      ...
      window.mapCrowdFlowObserved.zoomControl.setPosition('topright');
      var data = [];
      var layout = {};
      ...
      if(window.bounds && window['DEFAULT_MAP_ZOOM']) {
        ...
        if(window['DEFAULT_MAP_LOCATION'] && window['DEFAULT_MAP_ZOOM'])
          ...
          window.mapCrowdFlowObserved.setView([window['DEFAULT_MAP_LOCATION']['coordinates'][1], window['DEFAULT_MAP_LOCATION']['coordinates'][0]]);
      }
      ...
      window.mapCrowdFlowObserved.addLayer(drawnItems);
      ...
      window.mapCrowdFlowObserved.addControl(drawControl);
      window.mapCrowdFlowObserved.on(L.Draw.Event.CREATED, function (event) {
...
function patchLocation(target, location) {
  patchCrowdFlowObservedVal([{ name: 'softCommit', value: 'true' }, { name: 'fq', value: 'entityShortId:' + result.entityShortId }]
...
function animateStats() {
  document.querySelector('#pageSearchVal-fqCrowdFlowObserved_time').innerText = '';
  searchPage('CrowdFlowObserved', function() {
    ...
    let animateInterval = window.setInterval(() => {
      ...
      document.querySelector('#fqCrowdFlowObserved_time').value = x;
      document.querySelector('#fqCrowdFlowObserved_time').onchange();
