Promise.all([
  ...
  document.querySelector('#htmButton_searchpagefrfrFishingBoat')?.addEventListener('click', (event) => {
    document.querySelector('#searchpagefrfrFishingBoatDialog').open = true;
  });
