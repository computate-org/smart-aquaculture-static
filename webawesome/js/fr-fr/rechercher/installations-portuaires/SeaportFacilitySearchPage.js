Promise.all([
  ...
  document.querySelector('#htmButton_searchpagefrfrSeaportFacility')?.addEventListener('click', (event) => {
    document.querySelector('#searchpagefrfrSeaportFacilityDialog').open = true;
  });
